...
$(document).ready(function () {
    ...
    $("select").change(function () {
        ...
        var url = "GrandFinalRank?date=" + encodeURIComponent(xDate) + "&roundParam=" + encodeURIComponent(xRound) + "&category=" + encodeURIComponent(xCat) + "&other=" + encodeURIComponent(xOth) + "&top=" + encodeURIComponent(xTop);
